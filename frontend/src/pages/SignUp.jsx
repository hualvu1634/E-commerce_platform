...
const SignUp = () => {
  const [formData, setFormData] = useState({ username: '', password: '', name: '', phoneNumber: '' });
      ...
      <div className="mx-auto bg-white p-4" style={{maxWidth: '450px'}}>
        ...
        <form onSubmit={handleSignUp}>
          {/* ... Các input giữ nguyên ... */}
           ...
           <div className="mb-3"><label className="form-label text-muted">Tài khoản</label><input type="text" name="username" className="form-control rounded-0" onChange={handleChange} required /></div>
